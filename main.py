...
# load list of image && edge detection
...
# finding the test contour
    ...
    # Getting the bird's eye view, top-view of the test 
    ...
    # Print to screen score and corrects in test
